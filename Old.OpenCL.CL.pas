...
type
  ...
  TCL_image_desc = packed record
    ...
    image_width, image_height, image_depth, image_array_size, image_row_pitch, image_slice_pitch : TSize_t;
...
{$ENDIF}
  ...
  (* Device APIs *)
{$IFDEF CL_VERSION_1_0}
  TclGetDeviceIDs = function(platform : PCL_platform_id (* platform *); device_type : TCL_device_type;
    (* device_type *)
...
{$IFDEF CL_VERSION_1_2}
  TclCreateSubDevices = function(in_device : PCL_device_id; (* in_device *)
...
{$ENDIF}
  (* Context APIs *)
{$IFDEF CL_VERSION_1_0}
  TContextNotify = procedure(const Name : PAnsiChar; const Data : Pointer; size : TSize_t; Data2 : Pointer);
  {$IFDEF CDECL}cdecl{$ELSE}stdcall{$ENDIF};
{$ENDIF}
{$IFDEF CL_VERSION_1_0}
...
{$IFDEF CL_VERSION_2_0}
  TclCreateCommandQueueWithProperties = function(context : PCL_context; (* context *)
...
{$IFDEF CDECL}cdecl{$ELSE}stdcall{$ENDIF};
{$ENDIF}
  TclSetCommandQueuePropertyJEOApague = function(
...
{$IFDEF CL_VERSION_1_1}
  TclCreateSubBuffer = function(buffer : PCL_mem; (* buffer *)
    flags : TCL_mem_flags; (* flags *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclCreateImage = function(context : PCL_context; (* context *)
    flags : TCL_mem_flags; (* flags *)
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclCreatePipe = function(context : PCL_context; (* context *)
    flags : TCL_mem_flags; (* flags *)
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclGetPipeInfo = function(pipe : PCL_mem; (* pipe *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
  TclSetMemObjectDestructorCallback = function(memobj : PCL_mem; (* memobj *)
...
{$ENDIF}
  (* SVM Allocation APIs *)
{$IFDEF CL_VERSION_2_0}
  TclSVMAlloc = function(context : PCL_context; (* context *)
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclSVMFree = procedure(context : PCL_context; (* context *)
...
{$ENDIF}
  (* Sampler APIs *)
{$IFDEF CL_VERSION_1_0}
  TclCreateSampler = function(context : PCL_context; (* context *)
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclCreateSamplerWithProperties = function(context : PCL_context; (* context *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclCreateProgramWithBuiltInKernels = function(context : PCL_context; (* context *)
    num_devices : TCL_uint; (* num_devices *)
    const device_list : PCL_device_id; (* device_list *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclCompileProgram = function(_program : PCL_program; (* program *)
    num_devices : TCL_uint; (* num_devices *)
    const device_list : PPCL_device_id; (* device_list *)
    const options : PAnsiChar; (* options *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclLinkProgram = function(context : PCL_context; (* context *)
    num_devices : TCL_uint; (* num_devices *)
    const device_list : PPCL_device_id; (* device_list *)
    const options : PAnsiChar; (* options *)
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclSetKernelArgSVMPointer = function(kernel : PCL_kernel; (* kernel *)
    arg_index : TCL_uint; (* arg_index *)
    const arg_value : Pointer (* arg_value *)
    ) : TCL_int;
{$IFDEF CDECL}cdecl{$ELSE}stdcall{$ENDIF};
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclSetKernelExecInfo = function(kernel : PCL_kernel; (* kernel *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclGetKernelArgInfo = function(kernel : PCL_kernel; (* kernel *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
  TclCreateUserEvent = function(context : PCL_context; (* context *)
    errcode_ret : PCL_int (* errcode_ret *)
    ) : PCL_event;
{$IFDEF CDECL}cdecl{$ELSE}stdcall{$ENDIF};
{$ENDIF}
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
  TclSetUserEventStatus = function(event : PCL_event; (* event *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
  TclSetEventCallback = function(event : PCL_event; (* event *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
  TclEnqueueReadBufferRect = function(command_queue : PCL_command_queue; (* command_queue *)
    buffer : PCL_mem; (* buffer *)
    blocking_read : TCL_bool; (* blocking_read *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
  TclEnqueueWriteBufferRect = function(command_queue : PCL_command_queue; (* command_queue *)
    buffer : PCL_mem; (* buffer *)
    blocking_write : TCL_bool; (* blocking_write *)
    const buffer_origin : PSize_t; (* buffer_origin *)
    const host_origin : PSize_t; (* host_origin *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclEnqueueFillBuffer = function(command_queue : PCL_command_queue; (* command_queue *)
    buffer : PCL_mem; (* buffer *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
  TclEnqueueCopyBufferRect = function(command_queue : PCL_command_queue; (* command_queue *)
    src_buffer : PCL_mem; (* src_buffer *)
    dst_buffer : PCL_mem; (* dst_buffer *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclEnqueueFillImage = function(command_queue : PCL_command_queue; (* command_queue *)
    image : PCL_mem; (* image *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclEnqueueMigrateMemObjects = function(command_queue : PCL_command_queue; (* command_queue *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclEnqueueMarkerWithWaitList = function(command_queue : PCL_command_queue; (* command_queue *)
    num_events_in_wait_list : TCL_uint; (* num_events_in_wait_list *)
    const event_wait_list : PPCL_event; (* event_wait_list *)
    event : PPCL_event (* event *)
    ) : TCL_int;
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclEnqueueBarrierWithWaitList = function(command_queue : PCL_command_queue; (* command_queue *)
    num_events_in_wait_list : TCL_uint; (* num_events_in_wait_list *)
    const event_wait_list : PPCL_event; (* event_wait_list *)
    event : PPCL_event (* event *)
    ) : TCL_int;
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclEnqueueSVMFree = function(command_queue : PCL_command_queue; (* command_queue *)
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclEnqueueSVMMemcpy = function(command_queue : PCL_command_queue; (* command_queue *)
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclEnqueueSVMMemFill = function(command_queue : PCL_command_queue; (* command_queue *)
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclEnqueueSVMMap = function(command_queue : PCL_command_queue; (* command_queue *)
    blocking_map : TCL_bool; (* blocking_map *)
...
{$ENDIF}
{$IFDEF CL_VERSION_2_0}
  TclEnqueueSVMUnmap = function(command_queue : PCL_command_queue; (* command_queue *)
    svm_ptr : Pointer; (* svm_ptr *)
    num_events_in_wait_list : TCL_uint; (* num_events_in_wait_list *)
    const event_wait_list : PPCL_event; (* event_wait_list *)
    event : PPCL_event (* event *)
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclSetPrintfCallback = function(context : PCL_context; (* context *)
...
{$IFDEF CL_VERSION_1_0}
{$IFDEF CL_USE_DEPRECATED_OPENCL_1_1_APIS}
  TclEnqueueBarrier = function(command_queue : PCL_command_queue (* command_queue *) ) : TCL_int;
  {$IFDEF CDECL}cdecl{$ELSE}stdcall{$ENDIF};
{$ENDIF}
{$ENDIF}
...
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
  TclGetExtensionFunctionAddressForPlatform = function(platform : PCL_platform_id; (* platform *)
...
var
  OCL_Initialized : Boolean = False;
  OpenCL_Version : Integer = CL_VERSION_1_2;
...
{$IFDEF CL_VERSION_1_0}
    ...
    clCreateContextFromType := TclCreateContextFromType(oclGetProcAddress('clCreateContextFromType',
      OCL_LibHandle));
...
{$IFDEF CL_VERSION_1_0}
    ...
    clReleaseCommandQueue := TclReleaseCommandQueue(oclGetProcAddress('clReleaseCommandQueue',
      OCL_LibHandle));
    clGetCommandQueueInfo := TclGetCommandQueueInfo(oclGetProcAddress('clGetCommandQueueInfo',
      OCL_LibHandle));
{$IFDEF CL_USE_DEPRECATED_OPENCL_1_0_APIS}
    clSetCommandQueueProperty := TclSetCommandQueueProperty(oclGetProcAddress('clSetCommandQueueProperty',
      OCL_LibHandle));
{$ENDIF}
{$ENDIF}
    (* Memory Object APIs *)
...
{$ENDIF}
    ...
    clGetSupportedImageFormats := TclGetSupportedImageFormats(oclGetProcAddress('clGetSupportedImageFormats',
      OCL_LibHandle));
...
{$IFDEF CL_VERSION_1_1}
    clSetMemObjectDestructorCallback := TclSetMemObjectDestructorCallback
      (oclGetProcAddress('clSetMemObjectDestructorCallback', OCL_LibHandle));
{$ENDIF}
    (* Sampler APIs *)
{$IFDEF CL_VERSION_1_0}
...
{$ENDIF}
    (* Program Object APIs *)
{$IFDEF CL_VERSION_1_0}
    clCreateProgramWithSource := TclCreateProgramWithSource(oclGetProcAddress('clCreateProgramWithSource',
      OCL_LibHandle));
    clCreateProgramWithBinary := TclCreateProgramWithBinary(oclGetProcAddress('clCreateProgramWithBinary',
      OCL_LibHandle));
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
    clCreateProgramWithBuiltInKernels := TclCreateProgramWithBuiltInKernels
      (oclGetProcAddress('clCreateProgramWithBuiltInKernels', OCL_LibHandle));
{$ENDIF}
{$IFDEF CL_VERSION_1_0}
...
{$IFDEF CL_VERSION_1_2}
    ...
    clUnloadPlatformCompiler := TclUnloadPlatformCompiler(oclGetProcAddress('clUnloadPlatformCompiler',
      OCL_LibHandle));
{$ENDIF}
{$IFDEF CL_VERSION_1_0}
{$IFDEF CL_USE_DEPRECATED_OPENCL_1_1_APIS}
...
{$ENDIF}
    ...
    clGetProgramBuildInfo := TclGetProgramBuildInfo(oclGetProcAddress('clGetProgramBuildInfo',
      OCL_LibHandle));
{$ENDIF}
    (* Kernel Object APIs *)
{$IFDEF CL_VERSION_1_0}
    clCreateKernel := TclCreateKernel(oclGetProcAddress('clCreateKernel', OCL_LibHandle));
    clCreateKernelsInProgram := TclCreateKernelsInProgram(oclGetProcAddress('clCreateKernelsInProgram',
      OCL_LibHandle));
...
{$ENDIF}
{$IFDEF CL_VERSION_1_0}
    clGetKernelWorkGroupInfo := TclGetKernelWorkGroupInfo(oclGetProcAddress('clGetKernelWorkGroupInfo',
      OCL_LibHandle));
{$ENDIF}
    (* Event Object APIs *)
{$IFDEF CL_VERSION_1_0}
...
{$ENDIF}
    (* Profiling APIs *)
{$IFDEF CL_VERSION_1_0}
    clGetEventProfilingInfo := TclGetEventProfilingInfo(oclGetProcAddress('clGetEventProfilingInfo',
      OCL_LibHandle));
{$ENDIF}
    (* Flush and Finish APIs *)
{$IFDEF CL_VERSION_1_0}
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
    clEnqueueReadBufferRect := TclEnqueueReadBufferRect(oclGetProcAddress('clEnqueueReadBufferRect',
      OCL_LibHandle));
{$ENDIF}
{$IFDEF CL_VERSION_1_0}
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
    clEnqueueWriteBufferRect := TclEnqueueWriteBufferRect(oclGetProcAddress('clEnqueueWriteBufferRect',
      OCL_LibHandle));
{$ENDIF}
{$IFDEF CL_VERSION_1_0}
...
{$ENDIF}
{$IFDEF CL_VERSION_1_1}
    clEnqueueCopyBufferRect := TclEnqueueCopyBufferRect(oclGetProcAddress('clEnqueueCopyBufferRect',
      OCL_LibHandle));
{$ENDIF}
{$IFDEF CL_VERSION_1_0}
...
{$IFDEF CL_VERSION_1_0}
    ...
    clEnqueueCopyImageToBuffer := TclEnqueueCopyImageToBuffer(oclGetProcAddress('clEnqueueCopyImageToBuffer',
      OCL_LibHandle));
    clEnqueueCopyBufferToImage := TclEnqueueCopyBufferToImage(oclGetProcAddress('clEnqueueCopyBufferToImage',
      OCL_LibHandle));
    ...
    clEnqueueUnmapMemObject := TclEnqueueUnmapMemObject(oclGetProcAddress('clEnqueueUnmapMemObject',
      OCL_LibHandle));
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
    clEnqueueMigrateMemObjects := TclEnqueueMigrateMemObjects(oclGetProcAddress('clEnqueueMigrateMemObjects',
      OCL_LibHandle));
{$ENDIF}
{$IFDEF CL_VERSION_1_0}
    clEnqueueNDRangeKernel := TclEnqueueNDRangeKernel(oclGetProcAddress('clEnqueueNDRangeKernel',
      OCL_LibHandle));
    clEnqueueTask := TclEnqueueTask(oclGetProcAddress('clEnqueueTask', OCL_LibHandle));
    clEnqueueNativeKernel := TclEnqueueNativeKernel(oclGetProcAddress('clEnqueueNativeKernel',
      OCL_LibHandle));
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
    clEnqueueMarkerWithWaitList := TclEnqueueMarkerWithWaitList
      (oclGetProcAddress('clEnqueueMarkerWithWaitList', OCL_LibHandle));
    clEnqueueBarrierWithWaitList := TclEnqueueBarrierWithWaitList
      (oclGetProcAddress('clEnqueueBarrierWithWaitList', OCL_LibHandle));
...
{$IFDEF CL_USE_DEPRECATED_OPENCL_1_1_APIS}
    ...
    clEnqueueWaitForEvents := TclEnqueueWaitForEvents(oclGetProcAddress('clEnqueueWaitForEvents',
      OCL_LibHandle));
...
{$IFDEF CL_USE_DEPRECATED_OPENCL_1_1_APIS}
    clGetExtensionFunctionAddress := TclGetExtensionFunctionAddress
      (oclGetProcAddress('clGetExtensionFunctionAddress', OCL_LibHandle));
{$ENDIF}
{$ENDIF}
{$IFDEF CL_VERSION_1_2}
    clGetExtensionFunctionAddressForPlatform := TclGetExtensionFunctionAddressForPlatform
      (oclGetProcAddress('clGetExtensionFunctionAddressForPlatform', OCL_LibHandle));
{$ENDIF}


{$IFDEF CL_VERSION_2_0}
    clCreateCommandQueueWithProperties := TclCreateCommandQueueWithProperties
      (oclGetProcAddress('clCreateCommandQueueWithProperties', OCL_LibHandle));
    ...
    clCreateSamplerWithProperties := TclCreateSamplerWithProperties
      (oclGetProcAddress('clCreateSamplerWithProperties', OCL_LibHandle));
    clSetKernelArgSVMPointer := TclSetKernelArgSVMPointer(oclGetProcAddress('clSetKernelArgSVMPointer',
      OCL_LibHandle));
...
begin
  Result := '';
  case Status of
    CL_SUCCESS : Result := 'Sucesso';
    CL_DEVICE_NOT_FOUND : Result := 'Dispositivo não encontrado';
    CL_DEVICE_NOT_AVAILABLE : Result := 'Dispositivo não disponível';
    CL_COMPILER_NOT_AVAILABLE : Result := 'Compilador não disponível';
    CL_MEM_OBJECT_ALLOCATION_FAILURE : Result := 'Falha na alocação de objeto de memória';
    CL_OUT_OF_RESOURCES : Result := 'Sem recursos';
    CL_OUT_OF_HOST_MEMORY : Result := 'Sem memória do host';
    CL_PROFILING_INFO_NOT_AVAILABLE : Result := 'Informações de perfil não disponíveis';
    CL_MEM_COPY_OVERLAP : Result := 'Sobreposição na cópia de memória';
    CL_IMAGE_FORMAT_MISMATCH : Result := 'Incompatibilidade de formato de imagem';
    CL_IMAGE_FORMAT_NOT_SUPPORTED : Result := 'Formato de imagem não suportado';
    CL_BUILD_PROGRAM_FAILURE : Result := 'Falha na compilação do programa';
    CL_MAP_FAILURE : Result := 'Falha no mapeamento';
    CL_MISALIGNED_SUB_BUFFER_OFFSET : Result := 'Deslocamento de sub-buffer desalinhado';
    CL_EXEC_STATUS_ERROR_FOR_EVENTS_IN_WAIT_LIST :
        Result := 'Erro de status de execução para eventos na lista de espera';
    CL_COMPILE_PROGRAM_FAILURE : Result := 'Falha na compilação do programa';
    CL_LINKER_NOT_AVAILABLE : Result := 'Linker não disponível';
    CL_LINK_PROGRAM_FAILURE : Result := 'Falha na linkagem do programa';
    CL_DEVICE_PARTITION_FAILED : Result := 'Falha na partição do dispositivo';
    CL_KERNEL_ARG_INFO_NOT_AVAILABLE : Result := 'Informações de argumento do kernel não disponíveis';
    CL_INVALID_VALUE : Result := 'Valor inválido';
    CL_INVALID_DEVICE_TYPE : Result := 'Tipo de dispositivo inválido';
    CL_INVALID_PLATFORM : Result := 'Plataforma inválida';
    CL_INVALID_DEVICE : Result := 'Dispositivo inválido';
    CL_INVALID_CONTEXT : Result := 'Contexto inválido';
    CL_INVALID_QUEUE_PROPERTIES : Result := 'Propriedades de fila inválidas';
    CL_INVALID_COMMAND_QUEUE : Result := 'Fila de comandos inválida';
    CL_INVALID_HOST_PTR : Result := 'Ponteiro de host inválido';
    CL_INVALID_MEM_OBJECT : Result := 'Objeto de memória inválido';
    CL_INVALID_IMAGE_FORMAT_DESCRIPTOR : Result := 'Descritor de formato de imagem inválido';
    CL_INVALID_IMAGE_SIZE : Result := 'Tamanho de imagem inválido';
    CL_INVALID_SAMPLER : Result := 'Sampler inválido';
    CL_INVALID_BINARY : Result := 'Binário inválido';
    CL_INVALID_BUILD_OPTIONS : Result := 'Opções de compilação inválidas';
    CL_INVALID_PROGRAM : Result := 'Programa inválido';
    CL_INVALID_PROGRAM_EXECUTABLE : Result := 'Executável de programa inválido';
    CL_INVALID_KERNEL_NAME : Result := 'Nome de kernel inválido';
    CL_INVALID_KERNEL_DEFINITION : Result := 'Definição de kernel inválida';
    CL_INVALID_KERNEL : Result := 'Kernel inválido';
    CL_INVALID_ARG_INDEX : Result := 'Índice de argumento inválido';
    CL_INVALID_ARG_VALUE : Result := 'Valor de argumento inválido';
    CL_INVALID_ARG_SIZE : Result := 'Tamanho de argumento inválido';
    CL_INVALID_KERNEL_ARGS : Result := 'Argumentos de kernel inválidos';
    CL_INVALID_WORK_DIMENSION : Result := 'Dimensão de trabalho inválida';
    CL_INVALID_WORK_GROUP_SIZE : Result := 'Tamanho de grupo de trabalho inválido';
    CL_INVALID_WORK_ITEM_SIZE : Result := 'Tamanho de item de trabalho inválido';
    CL_INVALID_GLOBAL_OFFSET : Result := 'Deslocamento global inválido';
    CL_INVALID_EVENT_WAIT_LIST : Result := 'Lista de espera de eventos inválida';
    CL_INVALID_EVENT : Result := 'Evento inválido';
    CL_INVALID_OPERATION : Result := 'Operação inválida';
    CL_INVALID_GL_OBJECT : Result := 'Objeto GL inválido';
    CL_INVALID_BUFFER_SIZE : Result := 'Tamanho de buffer inválido';
    CL_INVALID_MIP_LEVEL : Result := 'Nível MIP inválido';
    CL_INVALID_GLOBAL_WORK_SIZE : Result := 'Tamanho de trabalho global inválido';
    CL_INVALID_PROPERTY : Result := 'Propriedade inválida';
    CL_INVALID_IMAGE_DESCRIPTOR : Result := 'Descritor de imagem inválido';
    CL_INVALID_COMPILER_OPTIONS : Result := 'Opções de compilador inválidas';
    CL_INVALID_LINKER_OPTIONS : Result := 'Opções de linker inválidas';
    CL_INVALID_DEVICE_PARTITION_COUNT : Result := 'Contagem de partição de dispositivo inválida';
  end;
end;
{$IFNDEF DEFINE_REGION_NOT_IMPLEMENTED}{$ENDREGION}{$ENDIF}
